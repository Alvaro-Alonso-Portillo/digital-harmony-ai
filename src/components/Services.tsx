...
const services = [
  {
    icon: <Zap className="h-6 w-6 text-agency-turquoise" />,
  ...
  {
    icon: <LineChart className="h-6 w-6 text-agency-turquoise" />,
  ...
  {
    icon: <Layout className="h-6 w-6 text-agency-turquoise" />,
  ...
  {
    icon: <BarChart className="h-6 w-6 text-agency-turquoise" />,
  ...
  {
    icon: <MessageSquare className="h-6 w-6 text-agency-turquoise" />,
  ...
  {
    icon: <Search className="h-6 w-6 text-agency-turquoise" />,
      ...
      <div className="container-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="h-12 w-12 rounded-lg bg-agency-blue/10 dark:bg-agency-blue/20 flex items-center justify-center mb-5 group-hover:bg-agency-turquoise/20 transition-colors">
                {service.icon}
              </div>
              ...
              <ul className="space-y-2 mb-6">
                {service.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start">
                    <span className="h-5 w-5 rounded-full bg-agency-turquoise/10 flex items-center justify-center flex-shrink-0 mt-0.5 mr-2">
                      <span className="h-1.5 w-1.5 rounded-full bg-agency-turquoise"></span>
                    </span>
              ...
              <Button variant="ghost" className="text-agency-turquoise hover:text-agency-blue hover:bg-agency-turquoise/10 w-full mt-auto">
                Saber más
              </Button>
            </div>
          ))}
        ...
        <div className="mt-16 text-center">
          <Button asChild size="lg" className="bg-agency-blue hover:bg-agency-turquoise text-white">
